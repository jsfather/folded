  ...
  return (
    <form action={formAction} className="space-y-3">
      <div className="flex-1 rounded-lg bg-gray-50 px-6 pt-8 pb-4">
        <h1 className="mb-3 text-2xl">برای ادامه وارد شوید.</h1>
        <div className="w-full">
          <div>
            ...
            <div className="relative">
              <input
                className="peer block w-full rounded-md border border-gray-200 py-[9px] pr-4 text-sm outline-2 placeholder:text-gray-500"
                id="email"
                type="email"
                name="email"
        ...
        <Button className="mt-4 w-full">
          ورود <ArrowLeftIcon className="ml-auto h-5 w-5 text-gray-50" />
        </Button>
