...
import { Transaction, CreateTransactionData, UpdateTransactionData, MonthlyStats } from '@/lib/types/transaction';
...
export async function updateTransaction(transactionData: UpdateTransactionData): Promise<Transaction> {
  const supabase = createClient();
